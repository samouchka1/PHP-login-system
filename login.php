...
<body>
    ...
    <p id="signature" class="text-xs md:text-sm text-right my-4 mr-2 md:mr-40 lg:mr-96 pr-0 lg:pr-8">&copy;<script>document.write(new Date().getFullYear());</script> samouchka</p>
